...
class BacktestServiceTest extends Specification {
    ...
    private backtestService = new BacktestService(
        backtestExchangeGateway, strategyExecutionFactory, clockSignalDispatcher, reportBuilder)
    ...
    def 'should run backtest correctly'() {
        ...
        1 * backtestExchangeGateway.getStartTimestamp() >> START_TIMESTAMP
        1 * backtestExchangeGateway.getEndTimestamp() >> END_TIMESTAMP
        // 23:55:00 2021-11-19
        1 * backtestExchangeGateway.setCurrentTimestamp(1637366100000L)
        1 * clockSignalDispatcher.dispatch(new ClockSignal(ONE_SECOND, 1637366100000L))
        ...
        1 * clockSignalDispatcher.dispatch(new ClockSignal(ONE_SECOND, 1637366160000L))
        ...
        1 * clockSignalDispatcher.dispatch(new ClockSignal(ONE_SECOND, 1637366220000L))
        ...
        1 * clockSignalDispatcher.dispatch(new ClockSignal(ONE_SECOND, 1637366280000L))
        ...
        1 * clockSignalDispatcher.dispatch(new ClockSignal(ONE_SECOND, 1637366340000L))
        ...
        1 * clockSignalDispatcher.dispatch(new ClockSignal(ONE_SECOND, 1637366400000L))
