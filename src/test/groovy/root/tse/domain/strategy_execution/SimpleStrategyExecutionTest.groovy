...
class SimpleStrategyExecutionTest extends Specification {
    ...
    private strategyExecutionContext = StrategyExecutionContext.builder().strategy(strategy)
        .symbols([SYMBOL_1]).strategyExecutionMode(STRATEGY_EXECUTION_MODE).fundsPerTrade(FUNDS_PER_TRADE).build()
